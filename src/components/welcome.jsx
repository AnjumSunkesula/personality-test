  ...
  return(
    <>
      <div className="flex flex-col justify-center items-center min-h-screen gap-8 bg-gray-100">
        <div className="w-36 h-36 bg-gradient-to-r from-violet-800  to-pink-400 rounded-full animate-bounce" 
          style={{
            animationDuration: "5s",
            animationTimingFunction: "ease-in-out"
          }}
        ></div>
        <div className=" text-center font-sans capitalize bg-gradient-to-r from-violet-800 to-pink-400 bg-clip-text text-transparent text-5xl py-2">discover your personality profile</div>
